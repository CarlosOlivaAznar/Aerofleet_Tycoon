...
return [
    ...
    'youtubeVideoTitle' => 'Video en youtube',
    'youtubeVideo' => '<p>
            Para un analisis en detalle de los conceptos basicos de la aplicacion mira nuestro tutorial oficial en youtube sobre los conceptos de crear rutas y la gestion de la flota y espacios. Para guiarte lee la descripcion del video donde encontraras los capitulos del tutorial. <a href="https://www.youtube.com/watch?v=RPQ9NV_zOZc" target="_blank">Clica aqui para ver el tutorial</a>
        </p>',
    
    'fleetManagementTitle' => 'Gestión de la flota',
    'fleetManagement' => '<p>
    ...
    'buyAircraftTitle' => 'Compra de aviones',
    'buyAircraft' => '<p>
    ...
    'routeManagementTitle' => 'Gestión de las rutas',
    'routeManagement' => '<p>
    ...
    'slotsManagementTitle' => 'Gestión de los espacios',
    'slotsManagement' => '<p>
    ...
    'spyOnYourCompetenceTitle' => 'Espiar a la competencia',
    ...
    'moreInfoTitle' => '¿Mas dudas?',
    'moreInfo' => '
            Si tienes mas dudas sobre la aplicacion no dudes en entrar en nuestro servidor de <a href="https://discord.gg/sUueRvrttY" target="_blank">Discord</a>, si no quieres y piensas que has encontrado un bug, (dentro de la aplicacion) en el menu superior encontraras un boton para reportar un bug. Si quieres conocer mas sobre este proyecto te invito a visitar la pagina ',
    'moreInfoAM' => 'Sobre mi',
];
